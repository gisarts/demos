        ...
        <!-- <img src="./img/footer.png" alt="footer" class="footer_background"> -->
        <footer class="text-center footer h-50">
            <div class="container">
                <div class="row justify-content-center">
                    <!-- <div class="col">
                        <h2><b>CO</b>OK is een project van</h2>
                    </div> -->
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <a class="gisarts_link" href="https://www.gisarts.nl" target="_Blank">
                                <img src="./img/logo_gisarts.png" alt="logo_gisarts" class="w-100" style="filter: brightness(0) invert(1);">
                            </a>
                        </div>
                        <div class="col-4">
                            <h3>Over ons</h3>
                            <p>
                                GISArts is opgericht door Fons Arts. Met een netwerk van consultants en uiteenlopende specialisten is Fons constant bezig zijn knowhow up-to-date te houden.
                            </p>
                        </div>
                        <div class="col-4">
                            <h3>Contact</h3>
                    ...
                    <div class="col">
                        <hr>
                        <p>© 2022 <a href="https://www.gisarts.nl" target="_Blank">Gisarts.nl</a> | Alle rechten voorbehouden. </p>
                    </div>
                </div>
            </div>
        </footer>
