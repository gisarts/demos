    ...
    <div class="container-sm">
        ...
        <div class="row">
            ...
            <div class="col-lg align-self-center">
                <h4 class="text-gold m-0">IMPORT EXPORT BESTANDEN</h4>
                <h2>Voeg zelfstandig bestanden toe van KML tot JSON</h2>
                <p class="w-75 r-text">In de Geo wereld wordt met veel verschillende bestanden gewerkt, Deze kan de klant zelf toevoegen aan de GIS Viewer van COOK. Andersom is het ook mogelijk om gegevens te exporteren naar Shape en Excel bestanden. Daarnaast is het ook mogelijk om KML en GeoJSon bestanden toe te voegen. Sleep de bestanden in het kaartbeeld en COOK geeft de informatie weer. PDOK heeft een groot aantal datasets downloads beschikbaar. Ook deze kunnen moeiteloos in de COOK GIS Viewer worden toegevoegd.</p>
            </div>
        </div>
    </div>
</div>