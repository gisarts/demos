        ...
        <footer class="text-center footer w-100 ">
            <div class="container">
                <div class="row justify-content-center inv">
                    <div class="col-xxl-2 r-padding">
                        <span onclick="window.scrollTo(0, 0);" class="text-decoration-none" style="cursor: pointer;">
                            <p style="font-size: 50px"><b>↑</b></p>
                        </span>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="row">
                        ...
                        <div class="col-md-4 .r-logo">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-lock inv" viewBox="0 0 330 330">
                                ...
                                <div class="col-sm-8">
                                    <p><a href="https://www.gisarts.nl/privacyverklaring" target="_Blank">Privacyverklaring</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
