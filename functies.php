            ...
            <div class="col">
                <div class="card mb-5 rounded-4 f-card">
                    <div class="card-body">
                        ...
                        <h4 class="text-gold">LEGENDA <b>AANPASSEN</b></h4>
                        <p class="fs-6 text-gold">
                            De legenda van de COOK GIS Viewer kan zelf aangepast en ingericht worden. Markeer favoriete locaties, filter informatie en maak selecties. 
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card mb-5 rounded-4 f-card">
                    <div class="card-body">
                        ...
                        <h4 class="text-gold"><b>3D</b> VIEWER</h4>
                        <p class="fs-6 text-gold">
                            Bekijk topografie of huizen op een realistische wijze. Met landmeetkundige apparatuur en drones is het 3D model in de GIS Viewer op de cm nauwkeurig.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card mb-5 rounded-4 f-card">
                    <div class="card-body">
                        ...
                        <h4 class="text-gold"><b>CAD</b> TEKENINGEN</h4>
                        <p class="fs-6 text-gold">
                            De technische CAD tekeningen worden moeiteloos in COOK geladen. Handig voor het raadplegen van een project of een handige fasering op kaart
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card mb-5 rounded-4 f-card">
                    <div class="card-body">
                        ...
                        <h4 class="text-gold"><b>ACTUELE</b> SATELLIETBEELDEN</h4>
                        <p class="fs-6 text-gold">
                            Naast luchtfoto's wordt er ook gebruikt gemaakt van satellietbeelden in de GIS Viewer van COOK. Gemiddeld zes keer per jaar van hoge resolutie.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="row align-items-center logo-background">
    ...
    <div class="col-lg-7">
        <div class="container-sm p-5">
            <h2 class="text-gold">BIRDSEYE <b>WEERGAVE</b></h2>
            <p class="w-75 r-text">Deze beelden zijn onder een hoe van 45° opgenomen en bezitten veel detail informatie. De beelden kunnen in de GIS Viewer van COOK opgeroepen worden waaruit ze van 4 kanten te bekijken zijn. De beelden zijn van hoge kwaliteit en worden gebruik bij planning, bouw/infrastructuur, groenvoorziening en veel meer.</p>
        </div>
    </div>
</div>
