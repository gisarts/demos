            ...
            <div class="card mb-5 rounded-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="fs-6 mb-0">
                                Importeer en exporteer verschillende soorten bestanden met COOK van Json tot KML
                            </p>
                        </div>
            ...
            <div class="card rounded-4">
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <p class="fs-6 mb-0">
                                Live overzicht van uitgevoerd werk en data in beeld met grafieken en diagrammen
                            </p>
                        </div>
                        <div class="col" style="display: table;">
                            <p class="text-gold align-bottom fs-6 text-end" style="display: table-cell;">
        ...
        <div class="row py-5">
            <div class="col-xl-3 p-0">
                <div class="p-4" style="background-color: white;">
                    <img src="./img/logo_cook.webp" height="100px" alt="">
                </div>
                <div class="p-3" style="background-color: rgb(161, 117, 18);">
