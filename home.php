            ...
            <div class="card mb-5 rounded-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="fs-6 mb-0">
                                Importeer en exporteer diverse bestandsformaten met COOK, van JSON tot KML.
                            </p>
                        </div>
                        <div class="col" style="display: table;">
                            <p class="text-gold align-bottom fs-6 text-end" style="display: table-cell;">
                                <a href="/functies" class="text-gold" style="text-decoration: none;"><b>></b> Lees meer</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card rounded-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <p class="fs-6 mb-0">
                                Krijg live inzicht in uitgevoerde werkzaamheden en data via grafieken en diagrammen.
                            </p>
                        </div>
                        <div class="col" style="display: table;">
                            <p class="text-gold align-bottom fs-6 text-end" style="display: table-cell;">
